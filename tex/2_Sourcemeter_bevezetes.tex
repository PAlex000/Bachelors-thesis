...
\Aref{fig:JavaScriptSchema_struktura} ábrán a ProjektNév/Model/Csomagok struktúra figyelhető meg.
...
\Aref{lst:ExportAllDeclaration} kódrészletben ez az \texttt{extends BaseNode}-al van jelezve.
...
Így lett minden csomag és osztály felépítve.
...
A DataStructures csomagban található 2 csomag, Kinds és Typedefs. \Aref{fig:JavaScriptSchema_struktura} ábrán látható. Ebből a Kinds csomagot mutatom be.
\Aref{fig:data_structures_kinds} ábrán a Kinds csomagnak egy kisebb része látható.
...
A 3 karakter, amit minden konstans előtt szerepel, azok kikerülnek paraméterbe és csak az utáni stringet írta át az ASG fájlba.
Ugyanígy jár el a többi enumnál is.
Ha az összes enumot beleírta, akkor a többi csomagot kezdi el bele írni a fájlba. \Aref{fig:JavaScriptSchema_struktura} alapján halad sorban.
...
lim::asg::logical::Class& classLimNode =
dynamic_cast<lim::asg::logical::Class&>(createLimNode(clNode, callVirtualBase));
