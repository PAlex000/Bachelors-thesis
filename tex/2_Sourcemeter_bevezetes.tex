...
\Aref{fig:JavaScriptSchema_struktura} ábrán a ProjektNév/Model/Package-ek struktúra figyelhető meg.
...
Ha az összes enumot beleírta, akkor a többi package-et kezdi el bele írni a fájlba. \Aref{fig:JavaScriptSchema_struktura} alapján halad sorban.
